...
See `nim doc gatabase.nim`, `runnableExamples`, [examples folder](https://github.com/juancarlospaco/nim-gatabase/tree/master/examples), [Std Lib db_postgres](https://nim-lang.github.io/Nim/db_postgres.html) for more documentation.
